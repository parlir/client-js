module.exports = {
    ...
    exclude: ["node_modules", "src/index.ts", "src/lib/abortcontroller-polyfill.d.ts"],

    // Define patterns for files that should be considered being external.
    externalPattern: ["node_modules", "abortcontroller-polyfill"],
    ...
    // Emits a list of broken symbol [[navigation]] links after documentation
    // generation
    ...
    // Path to the readme file that should be displayed on the index page.
    // Pass `none` to disable the index page and start the documentation
    // on the globals page.
    readme: "../README.md",
    
    // Specify the path to the theme that should be used or 'default' or
    // 'minimal' to use built-in themes.
    ...
    // specified TypeDoc will look for 'tsconfig.json' in the current
    // directory.
