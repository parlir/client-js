...
function resolveRefs(obj, fhirOptions, cache, client, signal) {
    ...
    let paths = util_1.makeArray(fhirOptions.resolveReferences)
...
class Client {
    ...
    getPatientId() {
        ...
        if (tokenResponse) {
            ...
            console.warn(this.hasGrantedScope("launch") || this.hasGrantedScope("launch/patient") ?
                exports.msg.noPatientAvailable :
                exports.msg.noPatientScopes);
        }
        else {
    ...
    getEncounterId() {
        ...
        if (tokenResponse) {
            ...
            console.warn(this.hasGrantedScope("launch") || this.hasGrantedScope("launch/encounter") ?
                exports.msg.noEncounterAvailable :
                exports.msg.noEncounterScopes);
        }
        else {
    ...
    async request(requestOptions, fhirOptions = {}, _resolvedRefs = {}) {
        ...
        _1.assert(requestOptions, exports.msg.requestNeedsArgs);
        // url -----------------------------------------------------------------
        let url;
        if (typeof requestOptions == "string" || requestOptions instanceof URL) {
    ...
    refresh(requestOptions = {}) {
        ...
        if (!this._refreshTask) {
            this._refreshTask = _1.request(tokenUri, refreshRequestOptions)
                .then(data => {
     ...
     */
    getState(path = "") {
        return _1.getPath({ ...this.state }, path);
    }
    /**
     ...
     */
    getFhirVersion() {
        return _1.fetchConformanceStatement(this.state.serverUrl)
